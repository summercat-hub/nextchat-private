...
const cn = {
  ...
  Settings: {
    ...
    Danger: {
      Reset: {
        ...
        Action: "立即重置",
        Confirm: "是否确认重置所有设置项到默认值？",
      },
      Clear: {
        Title: "清除所有数据",
        SubTitle: "清除所有聊天、设置数据",
        Action: "立即清除",
        Confirm: "是否确认清除所有聊天、设置数据？",
      },
    },
    Lang: {
      Name: "语言",
  ...
  Store: {
    DefaultTopic: "新的聊天",
    BotHello: "你好，我是 Open Chat，需要了解些什么？",
    Error: "出错了，稍后重试吧",
    Prompt: {
      History: (content: string) => "这是历史聊天总结作为前情提要：" + content,
      Topic:
        "根据上面的聊天内容，提炼最能代表用户核心问题的四到五个字作为标题。只返回标题，不要解释、不要标点、不要引号、不要语气词或多余文本，不要返回“主题提炼”或“聊天主题”等占位词；如果没有明确主题，请直接返回“闲聊”",
      Summarize:
